...
class HealthyEatingRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'image' => $isCreate
                ? 'required|mimes:jpeg,jpg,png|max:2048|dimensions:max_width=3000,max_height=2000'
                : 'nullable|mimes:jpeg,jpg,png|max:2048|dimensions:max_width=3000,max_height=2000',
