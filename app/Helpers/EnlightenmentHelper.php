...
class EnlightenmentHelper
{
    public static function data($request,$enlightenment = null)
    {
        ...
        if($request->hasFile('image')){
            ...
            $request->image->move(public_path('uploads/enlightenment'), $image);
        }else{
            $image = !empty($enlightenment->image)? $enlightenment->image: NULL;
        }
        ...
        if ($request->hasFile('slider_image')) {
            foreach ($request->file('slider_image') as $slider_image) {
                if ($slider_image->isValid()) {
                    ...
                    $slider_image->move(public_path('uploads/enlightenment/slider_image'), $filename);
        ...
        $data = [
            'image' => $image,
            'slider_image' => !empty($enlightenment->slider_image)? $enlightenment->slider_image: $slider_images,
            'title' => $title,
            'slug' => $slug,
            'text' => $text,
            'fulltext' => $fulltext,
