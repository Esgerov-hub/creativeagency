    ...
    <div class="modal fade" id="addTaskModal" tabindex="-1" aria-labelledby="addTaskModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.tariff-category.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    @if(!empty($categories[0]) && isset($categories[0]))
        @foreach($categories as $value)
            ...
            <div class="modal fade" id="editTaskModal{{$value['id']}}" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <form action="{{ route('admin.tariff-category.update',$value['id']) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="modal-body">
                                <ul class="nav nav-pills nav-justified" role="tablist">
                                    ...
                                    <div class="tab-pane" id="editother{{$value['id']}}" role="tabpanel">
                                        <div class="row g-3">
                                            ...
                                            @if(!empty($value->image))
                                                <div class="col-md-5">
                                                    <img src="{{ asset('uploads/tariff-category/'.$value->image) }}" style="width: 288px;!important;">
                                                </div>
                                            @endif
                                            <div class="col-sm-12">
                                                <label class="form-label">@lang('admin.status')</label>
            ...
            <div class="modal fade" id="deletecategory{{$value['id']}}" tabindex="-1" aria-labelledby="deletecategory{{$value['id']}}Label" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.tariff-category.destroy',$value['id']) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <div class="modal-body">
